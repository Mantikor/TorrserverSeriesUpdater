...
From version 0.2.2 you can download precompiled binary (executable) files for Linux/MacOS/Windows in release section. Tested on: Windows 11 Pro x64, Windows 10 Pro x64, Ubuntu 20.04, Ubuntu 22.04, Debian server 11, MacOS. Arguments are same for binary and the script: `--cleanup/--rutor/--litrcc/--nnmclub --ts_url TORRSERVER_URL --ts_port TORRSERVER_PORT`.
